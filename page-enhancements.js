(function () {
  ...
  loadScript('./page-enhancements-core.js')
    ...
    .then(function () { return loadScript('./reference-library.js?v=1.0.6'); })
    .then(function () { return loadScript('./repository-manifest-loader.js?v=1.0.6'); })
    .then(function () { return loadScript('./app-release-ui.js?v=1.0.6'); })
    .then(function () { return loadLogoWithoutObserverLoop('./soil-survey-logo-v1.0.2.js?v=1.0.2&runtime-fix=20260728-1'); })
    .then(function () { return loadScript('./app-version-guard.js?v=1.0.6'); })
    ...
    .then(function () { return loadScript('./upload-token-default.js?v=1.0.6'); })
    .then(function () { return loadScript('./reply-workflow-core.js?v=1.0.6'); })
    .then(function () { return loadScript('./upload-auth-reply-batch.js?v=1.0.6'); })
