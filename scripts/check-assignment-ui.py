...
def check_assignment_ui(page,out,prefix):
    ...
    expect(page.locator('#adm-list .v2-row').nth(2).locator('.rd')).to_have_value('平山县')
    ...
    # Check a genuine, multi-step correction rather than only reselecting defaults.
    page.locator('[data-auto-import-toggle]').click()
